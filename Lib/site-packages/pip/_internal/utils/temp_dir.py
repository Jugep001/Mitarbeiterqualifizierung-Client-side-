...
class TempDirectoryTypeRegistry(object):
    """Manages temp.py directory behavior
    """
...
class AdjacentTempDirectory(TempDirectory):
    ...
    Attributes:
        original
            The original directory to create a temp.py directory for.
        path
    ...
    """
    # The characters that may be used to name the temp.py directory
